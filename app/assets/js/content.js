...
dwlTpl['g'] = function() {
  ...
  if ( typeof(dwlPopup.gBk) != 'undefined' ) {
    ...
    <!--n-->\
      ...
      jQuery('<div id="dwl-g" class="container dwl-kp-blk'+( gbkn > 0 ? '' : ' closed' )+'" data-before="'+gbkn+' item'+( gbkn > 1 ? 's' : '' )+' found in my bookmarks">'+b+'<button class="open">+</button><button class="close">-</button></div>').prependTo('#center_col');
